...
namespace Levels.UnityExtends.SceneManagement.IoC {
    ...
    public class Broadcaster_Scene_OnSceneUnlading : Notification.Broadcaster.Generic<World.Scene.Notifications.SceneUnloading, Levels.UnityExtends.SceneManagement.World.Scene.Management.SceneUnloadingProcess>
    {
        public override void SetupEventHooks() {
            Levels.UnityExtends.SceneManagement.World.Scene.Management.Events.OnSceneUnloading += HandleOnPerformed;
        }
