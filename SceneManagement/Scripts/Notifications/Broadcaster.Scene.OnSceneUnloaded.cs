...
namespace Levels.UnityExtends.SceneManagement.IoC {
    ...
    using Levels.Core.Results;
    
    using UnityEngine.ResourceManagement.ResourceProviders;
    using UnityEngine.SceneManagement;
    
    public class Broadcaster_Scene_OnSceneUnloaded : Notification.Broadcaster.Generic<World.Scene.Notifications.SceneUnloaded, OneOf<SceneInstance, Scene>> {
        public override void SetupEventHooks() {
            Levels.UnityExtends.SceneManagement.World.Scene.Management.Events.OnSceneUnloaded += HandleOnPerformed;
        }
