...
namespace Levels.UnityExtends.SceneManagement.IoC {
    ...
    public class Receiver_Scene_OnSceneActivating : Receiver<World.Scene.Notifications.SceneActivating, Levels.UnityExtends.SceneManagement.World.Scene.Management.SceneActivatingProcess> {
