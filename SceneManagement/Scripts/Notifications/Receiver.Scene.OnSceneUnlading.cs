...
namespace Levels.UnityExtends.SceneManagement.IoC {
    ...
    public class Receiver_Scene_OnSceneUnlading : Receiver<World.Scene.Notifications.SceneUnloading, Levels.UnityExtends.SceneManagement.World.Scene.Management.SceneUnloadingProcess> {
